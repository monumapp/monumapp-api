...
import com.monumapp.api.controllers.SearchController;
...
public class MonumentRoutes {
	...
	@GetMapping
	public List<Monument> findMonumentByName(
			@RequestParam(value="monumentName", defaultValue="") String monumentName
	) throws Exception {
		return searchController.show(monumentName);
	}
}
